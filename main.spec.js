describe('main.js', function(){
    describe('calculate()',function() {
        ...
        it('calls updateResult (example using and.returnValue)', function(){
            spyOn(window, 'updateResult');
            spyOn(Calculator.prototype, 'multiply').and.returnValue('whatever value you want');
            
            calculate('5*5');
            expect(window.updateResult).toHaveBeenCalled();
            expect(window.updateResult).toHaveBeenCalledWith('whatever value you want');
        });
        ...
        it('does not handles errors', function(){
